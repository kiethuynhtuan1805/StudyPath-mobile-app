...
import { AVATAR_URI, LOGOUT_URI } from "@/utils/uri";
import {
  Nunito_400Regular,
  Nunito_600SemiBold,
  Nunito_700Bold,
...
export default function ProfileScreen() {
  const { profile, loading, setRefetch } = useUser();
  ...
  useEffect(() => {
    const fetchAvatar = async () => {
      ...
      const response = await axios.get(
        `${AVATAR_URI}${profile?.code}/thumb/v1`,
        {
          headers: {
          ...
          <ScrollView>
            ...
            <View style={{ marginHorizontal: 16, marginTop: 30 }}>
              ...
              <TouchableOpacity
                ...
                onPress={() => router.push("/(routes)/scoreboard")}
              >
                <View
                  style={{
                    flexDirection: "row",
              ...
              <TouchableOpacity
                ...
                onPress={() => router.push("/(routes)/study-path")}
              >
                <View
                  style={{
                    flexDirection: "row",
